...
export interface InventoryReportRowProps {
  report: InventoryReport
}

export const InventoryReportRow = React.memo<InventoryReportRowProps>(({ report }) => {
  return (
    <tr className="border-b border-[var(--color-border-divider)] transition-colors hover:bg-[var(--color-action-hover)]">
      ...
      <td className="whitespace-nowrap px-4 py-3 text-sm font-medium text-[var(--color-brand-warning)]">
        {report.lowStock}
      </td>
      <td className="whitespace-nowrap px-4 py-3 text-sm font-medium text-[var(--color-brand-danger)]">
        {report.outOfStock}
      </td>
      <td className="whitespace-nowrap px-4 py-3">
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={() => console.log('View inventory report:', report.id)}
          ...
          <button
            type="button"
            onClick={() => console.log('Export inventory report:', report.id)}
...
InventoryReportRow.displayName = 'InventoryReportRow'
